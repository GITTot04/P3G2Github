...
public struct Body : ISerializable
{
    ...
    public void CopyFromBodyTrackingSdk(Microsoft.Azure.Kinect.BodyTracking.Body body, Calibration sensorCalibration)
    {
        ...
        for (int bodyPoint = 0; bodyPoint < Length; bodyPoint++)
        {
            ...
            // WE ADDED THIS
            HandController.leftHandPosition = new UnityEngine.Vector3(body.Skeleton.GetJoint(8).Position.X / 1000.0f, body.Skeleton.GetJoint(8).Position.Y / 1000.0f, body.Skeleton.GetJoint(8).Position.Z / 1000.0f);
            HandController.leftShoulderPosition = new UnityEngine.Vector3(body.Skeleton.GetJoint(5).Position.X / 1000.0f, body.Skeleton.GetJoint(5).Position.Y / 1000.0f, body.Skeleton.GetJoint(5).Position.Z / 1000.0f);
            HandController.rightHandPosition = new UnityEngine.Vector3(body.Skeleton.GetJoint(15).Position.X / 1000.0f, body.Skeleton.GetJoint(15).Position.Y / 1000.0f, body.Skeleton.GetJoint(15).Position.Z / 1000.0f);
            HandController.rightShoulderPosition = new UnityEngine.Vector3(body.Skeleton.GetJoint(12).Position.X / 1000.0f, body.Skeleton.GetJoint(12).Position.Y / 1000.0f, body.Skeleton.GetJoint(12).Position.Z / 1000.0f);
            // ^^
